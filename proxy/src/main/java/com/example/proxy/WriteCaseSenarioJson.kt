...
//    }
    ...
    private fun startJobOrCancel(job: CompletableJob, json: JSONObject) {
    ...
    private fun updateJobCompleteTextView(json: JSONObject) {
    ...
    fun writeFileAsync(json: JSONObject) {
        try {
...
//                showToast(msg)
    ...
    fun writeCaseSenarioJson(caseScenario: JSONObject, p0: Activity?) {
        ...
        startJobOrCancel(job, caseScenario)
